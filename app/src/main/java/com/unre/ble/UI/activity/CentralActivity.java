...
import com.unre.ble.UI.fragment.FragmentCentral;

public class CentralActivity extends BleBaseFragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //startFragment(new FragmentCentral());
        if (savedInstanceState == null) {
            BleBaseFragment fragment = new FragmentCentral();
